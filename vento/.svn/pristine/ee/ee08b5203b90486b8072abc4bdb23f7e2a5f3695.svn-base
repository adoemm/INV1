    ...
    <head>
        ...
        <script type="text/javascript" language="javascript" charset="utf-8">
            ...
            function enviarInfo(form, action) {
                if (action === "exportar") {
                    form.action = '<%=PageParameters.getParameter("mainContext") + PageParameters.getParameter("excelReports")%>/ConsumoCantidad.jsp?<%=WebUtil.encode(session, "imix")%>=<%=WebUtil.encode(session, UTime.getTimeMilis())%>';
                                form.submit();
                            }
            ...
            <div id="divBody">
                ...
                <div class="form-container" width="100%">                    
                    ...
                    <form id="report" name="report" method="post" enctype="application/x-www-form-urlencoded" target="_blank" action="<%=PageParameters.getParameter("mainContext") + PageParameters.getParameter("prints")%>/Totales4Subcategoria.jsp">
                        ...
                        <fieldset>
                            <legend>Consumo-Cantidad</legend>
                            <div>
                            ...
                            <div>
                                ...
                                <select name="peDestino" onchange="getDepartamento(this.value);getPersonal(this.value);">
                                    <option value=""></option>
