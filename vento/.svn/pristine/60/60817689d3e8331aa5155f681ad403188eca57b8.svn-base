            ...
            <div id="divBody">
                ...
                <div class="form-container" width="100%">                    
                    ...
                    <form name="usuario" method="post" action="<%=PageParameters.getParameter("mainController")%>" enctype="application/x-www-form-urlencoded" id="form">
                        ...
                        <input type="hidden" name="FormFrom" value="insertMarca"/>
                        <fieldset>
                            <legend>Nueva Marca</legend>
                        
                            <div>
                                <label for="nombreMarca">*Ingrese el nombre de la marca</label>          
                                <input name="nombreMarca" type="text" id="nombreMarca" value="" size="50" >
                            </div>
