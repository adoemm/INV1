...
<div id="HeaderLayer" style="position:absolute;text-align:left;top:0px;width:900px;height:197px;z-index:5;" title="">
    ...
    <div id="nombreSistema" style="position:absolute;left:235px;top:122px;width:700px;height:15px;z-index:2;">
        <span style="color:#DA001B;font-family:'Gotham Book';font-size:15px;"><strong>SIBIEN -Sistema de Inventario para Bienes Informáticos -Rev. <%=PageParameters.getParameter("revision")%><%=PageParameters.getParameter("testDBLabel")%></strong></span></div>
