            ...
            <div id="divBody">
                ...
                <div class="form-container" width="100%">                    
                      ...
                      <table width="100%" height="25px" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                            <td width="64%" height="25" align="left" valign="top">
                                ...
                                > <a class="NVL" href="<%=PageParameters.getParameter("mainContext") + PageParameters.getParameter("gui")%>/ConsultaDepartamento.jsp?<%=WebUtil.encode(session, "imix")%>=<%=WebUtil.encode(session, UTime.getTimeMilis())%>">Catálogo de Departamentos</a>
                                > Nuevo Departamento
                            </td>
                    ...
                    <form name="usuario" method="post" action="<%=PageParameters.getParameter("mainController")%>" enctype="application/x-www-form-urlencoded" id="form">
                        ...
                        <input type="hidden" name="FormFrom" value="insertDepartamento"/>
                        <fieldset>
                            <legend>Nuevo Departamento</legend>
                            <div>
                                <label for="v">*Ingrese el nombre del departamento</label>          
                                <input name="nombreDepartamento" type="text" id="nombreDepartamento" value="" size="50" >
                            </div>
