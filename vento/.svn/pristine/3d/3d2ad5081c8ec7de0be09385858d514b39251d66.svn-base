...
<html>
    <head>
        ...
        <%            String date_num = "SinNoInventario.xls";
    ...
    <body>
        <table style="font-weight: bold;">
            <tr>
                ...
                <td colspan="9">COLEGIO DE ESTUDIOS CIENTÍFICOS Y TECNOLÓGICOS DEL ESTADO DE MÉXICO
                    ...
                    <br>BIENES SIN NO. DE INVENTARIO
                </td>
            </tr>
        </table>
        <table border="0" width="100%">
            ...
            <%
                Iterator t =QUID.select_BienesSinNoInventario(WebUtil.decode(session, request.getParameter("idPlantel")),
