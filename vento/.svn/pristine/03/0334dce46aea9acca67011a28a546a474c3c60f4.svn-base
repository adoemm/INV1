        ...
        <div id="wrapper">
            <div id="divBody">
                ...
                <div class="form-container" width="100%">                    
                    ...
                    <form id="editarDetalle" name="editarDetalle" method="post" action="<%=PageParameters.getParameter("mainController")%>" enctype="application/x-www-form-urlencoded">
                        <input type="hidden" name="imix" value="<%=WebUtil.encode(session, UTime.getTimeMilis())%>"/>
                        <input type="hidden" name="FormFrom" value="editarDetalle"/>  
                        <input type="hidden" name="idDetalle" value="<%=request.getParameter("idDetalle")%>"/>  
                        <fieldset>
                            <legend>Editar Detalle</legend>
                            <%
