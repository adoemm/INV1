...
<%    try {
        if (fine) {
            if (request.getParameter(WebUtil.encode(session, "imix")) != null) {
                ...
                access4ThisPage.add("InsertDetalle");
        ...
        <div id="wrapper">
            <div id="divBody">
                ...
                <div class="form-container" width="100%">                    
                    ...
                    <form id="nuevoDetalle" name="nuevoDetalle" method="post" action="<%=PageParameters.getParameter("mainController")%>" enctype="application/x-www-form-urlencoded">
                        <input type="hidden" name="imix" value="<%=WebUtil.encode(session, UTime.getTimeMilis())%>"/>
                        <input type="hidden" name="FormFrom" value="nuevoDetalle"/>                        
                        <fieldset>
                            <legend>Nuevo Detalle</legend>
                            <div>
                                <label for="nombreDetalle">*Descripción:</label>
                                <input name="nombreDetalle" type="text" id="nombreDetalle" value="" size="40">
                            </div>                          
<!--                            <div>
                                <label for="valor">Valor:</label>
                                <input name="valor" type="text" id="valor" value="" size="50">
                            </div>-->
                        </fieldset>
