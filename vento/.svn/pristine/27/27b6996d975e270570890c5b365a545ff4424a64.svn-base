...
<%    try {
        if (fine) {
            if (request.getParameter(WebUtil.encode(session, "imix")) != null) {
                ...
                access4ThisPage.add("ConsultaOrdenSurtimiento");
...
<html lang="<%=PageParameters.getParameter("Content-Language")%>">
    <head>
        <title>Ordenes de Surtido</title>
    ...
    <body  onload="populate();">
            ...
            <div id="divBody">
                ...
                <div class="form-container" width="100%">
                    ...
                    <div id="contenent_info" >
                        ...
                        %>
                        <form name="setPlantel" method="post" enctype="application/x-www-form-urlencoded" id="setPlantel" action="<%=PageParameters.getParameter("mainContext") + PageParameters.getParameter("gui")%>/ConsultaOrdenSurtimiento.jsp?<%=WebUtil.encode(session, "imix")%>=<%=WebUtil.encode(session, UTime.getTimeMilis())%>">
                            <fieldset>
                        ...
                        <form name="usuario" method="post" action="" enctype="application/x-www-form-urlencoded" id="form">
                            <fieldset>
                                <legend>Ordenes de Surtido Realizadas</legend>
        ...
        function populate()
        {
            ...
            var cells = new Array();
                    ...
                    <%
                        int cont = 0;
                        it = QUID.select_OrdenSurtimiento4PlantelSolicita(idPlantel).iterator();
                        while (it.hasNext()) {
            ...
            cells[2] = '<%=listAux.get(14).toString().replaceAll("'", "&#39;")%>';
