...
<html>
    <head>
        ...
        <%            String date_num = "diferenteModeloMismoPatron.xls";
    ...
    <body>
        <table style="font-weight: bold;">
            <tr>
                ...
                <td colspan="9">COLEGIO DE ESTUDIOS CIENTÍFICOS Y TECNOLÓGICOS DEL ESTADO DE MÉXICO
                    ...
                    <br>BIENES DIFERENTE MODELO MISMO PATRON DE NÚMERO DE SERIE
                </td>
            </tr>
        </table>
        <%
        ...
        <table>
            ...
            <tr><td><%=datosModelo.get(0)+"-"+datosModelo.get(2) + " " + datosModelo.get(5)%></td></tr>
        ...
        <%
            if (!patrones.isEmpty()) {
                Iterator t = QUID.select_DiferenteModeloMismoPatron(WebUtil.decode(session, request.getParameter("idModelo")),
                        patrones,
