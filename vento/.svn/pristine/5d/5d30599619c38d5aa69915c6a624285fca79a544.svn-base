...
<html>
    <head>
        ...
        <%            String date_num = "todosPatrones.xls";
    ...
    <body>
        <table style="font-weight: bold;">
            <tr>
                ...
                <td colspan="9">COLEGIO DE ESTUDIOS CIENTÍFICOS Y TECNOLÓGICOS DEL ESTADO DE MÉXICO
                    ...
                    <br>BIENES TODOS LOS PATRONES POR MODELO
                </td>
            </tr>
        </table>
       ...
       <%
       Iterator t=QUID.select_PatronXMarcaXModelo(WebUtil.decode(session,request.getParameter("idModelo")),
               WebUtil.decode(session,request.getParameter("idMarca"))).iterator();
       %>
        <table>
            <tr  style="font-weight: bold;">
                ...
                <td>Patron</td>
                <td>Longitud</td>
                <td>Coeficiente de Presición</td>
                <td>Tipo</td>
