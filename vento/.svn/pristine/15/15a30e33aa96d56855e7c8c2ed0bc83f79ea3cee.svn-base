...
<html lang="<%=PageParameters.getParameter("Content-Language")%>">
    <head>
        <title>Nuevo Tipo de Compra</title>
            ...
            <div id="divBody">
                ...
                <div class="form-container" width="100%">                    
                      ...
                      <table width="100%" height="25px" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                            <td width="64%" height="25" align="left" valign="top">
                                ...
                                > <a class="NVL" href="<%=PageParameters.getParameter("mainContext") + PageParameters.getParameter("gui")%>/ConsultaTipo_Compra.jsp?<%=WebUtil.encode(session, "imix")%>=<%=WebUtil.encode(session, UTime.getTimeMilis())%>">Catálogo de Compras</a> 
                    ...
                    <form name="usuario" method="post" action="<%=PageParameters.getParameter("mainController")%>" enctype="application/x-www-form-urlencoded" id="form">
                        ...
                        <input type="hidden" name="FormFrom" value="insertTipo_Compra"/>
                        <fieldset>
                            <legend>Nuevo Tipo de Compra</legend>
                            <div>
                                <label for="compra">*Ingrese el tipo de compra</label>          
                                <input name="compra" type="text" id="compra" value="" size="50" >
                            </div>
