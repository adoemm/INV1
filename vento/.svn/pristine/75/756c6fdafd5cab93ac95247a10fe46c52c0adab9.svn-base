...
<%    try {
        if (fine) {
            if (request.getParameter(WebUtil.encode(session, "imix")) != null) {
                ...
                access4ThisPage.add("ConsultaOrdenSurtimientoPendiente");
...
<html lang="<%=PageParameters.getParameter("Content-Language")%>">
    <head>
        <title>Ordenes de Surtido Pendientes</title>
    ...
    <body  onload="populate();">
            ...
            <div id="divBody">
                ...
                <div class="form-container" width="100%">
                    ...
                    <div id="contenent_info" >
                        ...
                        %>
                        <form name="setPlantel" method="post" enctype="application/x-www-form-urlencoded" id="setPlantel" action="<%=PageParameters.getParameter("mainContext") + PageParameters.getParameter("gui")%>/ConsultaOrdenSurtimientoPendiente.jsp?<%=WebUtil.encode(session, "imix")%>=<%=WebUtil.encode(session, UTime.getTimeMilis())%>">
                            <fieldset>
        ...
        function populate()
        {
            ...
            var cells = new Array();
                    ...
                    <%
                        int cont = 0;
                        it = QUID.select_OrdenSurtimiento4PlantelSurte(idPlantel).iterator();
                        while (it.hasNext()) {
