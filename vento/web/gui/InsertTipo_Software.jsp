...
<html lang="<%=PageParameters.getParameter("Content-Language")%>">
    <head>
        <title>Nuevo Tipo de Software</title>
            ...
            <div id="divBody">
                ...
                <div class="form-container" width="100%">                    
                      ...
                      <table width="100%" height="25px" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                            <td width="64%" height="25" align="left" valign="top">
                                ...
                                > <a class="NVL" href="<%=PageParameters.getParameter("mainContext") + PageParameters.getParameter("gui")%>/ConsultaTipo_Software.jsp?<%=WebUtil.encode(session, "imix")%>=<%=WebUtil.encode(session, UTime.getTimeMilis())%>">Catálogo Tipos de Software</a> 
                                > Nuevo Tipo de Software
                            </td>
                    ...
                    <form name="usuario" method="post" action="<%=PageParameters.getParameter("mainController")%>" enctype="application/x-www-form-urlencoded" id="form">
                        ...
                        <input type="hidden" name="FormFrom" value="insertTipo_Software"/>
                        <fieldset>
                            <legend>Nuevo Tipo de Software</legend>
                        
                            <div>
                                <label for="tipo">*Ingrese el tipo de software</label>          
                                <input name="tipo" type="text" id="tipo" value="" size="50" >
                            </div>
