        ...
        <div id="wrapper">
            <div id="divBody">
                ...
                <div class="form-container" width="100%">                    
                    ...
                    <form name="insertConteoFisico" method="post" action="" enctype="application/x-www-form-urlencoded" id="insertConteoFisico">
                        <input type="hidden" name="<%=WebUtil.encode(session, "imix")%>" value="<%=WebUtil.encode(session, UTime.getTimeMilis())%>"/>
                        <input type="hidden" name="FormFrom" value="insertConteoFisico"/>
                        <input type="hidden" name="idPlantel" value="<%=request.getParameter("idPlantel")%>"/>
                        <fieldset>
                            <legend>Realizar Inventario</legend>
                            <div>
                                <label for="fechaRegistro">Fecha de Toma de Inventario (aaaa-mm-dd)</label>
                                <input type="text" class="w8em format-y-m-d divider-dash highlight-days-67" id="fechaRegistro"   name="fechaRegistro" value="" size="10" MAXLENGTH="10">
                            </div>
                            <div id="botonEnviarDiv" >
                                <input type="button" value="Guardar" name="Enviar" onclick="enviarInfo(document.getElementById('insertConteoFisico'));"/>
                            </div>      
                        </fieldset>
                    </form>
                    <div id="divResult"> 
