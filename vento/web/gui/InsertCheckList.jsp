...
<%    try {
        if (fine) {
            if (request.getParameter(WebUtil.encode(session, "imix")) != null) {
                ...
                access4ThisPage.add("InsertCheckList");
        ...
        <div id="wrapper">
            <div id="divBody">
                ...
                <div class="form-container" width="100%">                    
                    ...
                    <form name="insertChekList" method="post" action="" enctype="application/x-www-form-urlencoded" id="insertChekList">
                        <input type="hidden" name="<%=WebUtil.encode(session, "imix")%>" value="<%=WebUtil.encode(session, UTime.getTimeMilis())%>"/>
                        <input type="hidden" name="FormFrom" value="insertChekList"/>
                        <fieldset>
                            <legend>Nueva CheckList</legend>
                            <div>
                                <label for="descripcion">*Descripción</label>
                                <textarea name="descripcion" cols="35" rows="5"></textarea>
                            </div>
                            <div id="botonEnviarDiv" >
                                <input type="button" value="Guardar" name="Enviar" onclick="enviarInfo(document.getElementById('insertChekList'));"/>
                            </div>      
                        </fieldset>
                    </form>
                    <div id="divResult"> 
