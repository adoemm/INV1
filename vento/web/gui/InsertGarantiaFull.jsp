        ...
        <div id="wrapper">
            <div id="divBody">
                ...
                <div class="form-container" width="100%">                    
                    ...
                    <form name="insertGarantiaFull" method="post" action="" enctype="application/x-www-form-urlencoded" id="insertGarantiaFull">
                        <input type="hidden" name="<%=WebUtil.encode(session, "imix")%>" value="<%=WebUtil.encode(session, UTime.getTimeMilis())%>"/>
                        <input type="hidden" name="FormFrom" value="insertGarantiaFull"/>
                        ...
                        <fieldset>
                            ...
                            <div id="botonEnviarDiv" >
                                <input type="button" value="Guardar" name="Enviar" onclick="enviarInfo(document.getElementById('insertGarantiaFull'));"/>
                            </div>      
                        </fieldset>
                    </form>
                    <div id="divResult"> 
